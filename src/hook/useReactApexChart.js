...
const useReactApexChart = () => {
  ...
  let chartOptions = {
    ...
    stroke: {
      curve: "smooth",
      colors: ["#c02221"], // Specify the line color here
      width: 3,
    },
    markers: {
      size: 0,
  ...
  let barChartOptionsTwo = {
    ...
    fill: {
      type: "gradient",
      colors: ["#c02221"], // Set the starting color (top color) here
      gradient: {
        shade: "light", // Gradient shading type
        type: "vertical", // Gradient direction (vertical)
        shadeIntensity: 0.5, // Intensity of the gradient shading
        gradientToColors: ["#c02221"], // Bottom gradient color (with transparency)
        inverseColors: false, // Do not invert colors
        opacityFrom: 1, // Starting opacity
        opacityTo: 1, // Ending opacity
        stops: [0, 100],
  ...
  let candleStickChartOptions = {
    plotOptions: {
      candlestick: {
        colors: {
          upward: "#c02221", // Color for bullish candles (green)
  ...
  let columnChartOptionsThree = {
    ...
    colors: ["#c02221", "#FF9F29", "#48AB69", "#45B369"],
    plotOptions: {
      bar: {
        horizontal: false,
        borderRadius: 4,
  ...
  let zoomAbleLineChartOptions = {
    ...
    fill: {
      ...
      gradient: {
        ...
        type: "vertical", // Gradient direction (vertical)
        shadeIntensity: 0.5, // Intensity of the gradient shading
        gradientToColors: [`${"#c02221"}00`], // Bottom gradient color (with transparency)
        inverseColors: false, // Do not invert colors
        opacityFrom: 0.6, // Starting opacity
        opacityTo: 0.3, // Ending opacity
        stops: [0, 100],
  ...
  let lineDataLabelOptions = {
    ...
    colors: ["#c02221"], // Set the color of the series
    dataLabels: {
      enabled: true,
    },
    stroke: {
  ...
  let doubleLineChartOptions = {
    ...
    colors: ["#c02221", "#FF9F29"], // Set the color of the series
    dataLabels: {
      enabled: false,
    },
    stroke: {
  ...
  let pieChartOptionsTwo = {
    ...
    colors: ["#c02221", "#FF9F29", "#45B369", "#EF4A00"],
    plotOptions: {
      pie: {
        dataLabels: {
          dropShadow: {
  ...
  let basicDonutChartOptions = {
    ...
    colors: ["#16a34a", "#c02221", "#2563eb", "#dc2626", "#f86624", "#ffc107"],
    dataLabels: {
      enabled: false,
    },
    responsive: [
  ...
  let multipleSeriesChartOptions = {
    ...
    colors: ["#c02221", "#FF9F29", "#9935FE", "#EF4A00"],
    stroke: {
      colors: ["#c02221", "#FF9F29", "#9935FE", "#EF4A00"],
    },
    fill: {
  ...
  let enrollmentChartOptions = {
    ...
    stroke: {
      curve: "smooth",
      width: 3,
      colors: ["#c02221", "#FF9F29"], // Use two colors for the lines
      lineCap: "round",
    },
    grid: {
      show: true,
    ...
    fill: {
      type: "gradient",
      colors: ["#c02221", "#FF9F29"], // Use two colors for the gradient
    ...
    markers: {
      colors: ["#c02221", "#FF9F29"], // Use two colors for the markers
      strokeWidth: 3,
      size: 0,
      hover: {
        size: 10,
  ...
  let userOverviewDonutChartOptionsTwo = {
    colors: ["#FF9F29", "#c02221", "#45B369", "#9935FE"],
