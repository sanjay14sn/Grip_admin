                      ...
                      {chapter.members.map((member, index) => (
                        ...
                        >
                          <div className="d-flex align-items-center">
                            <img
                              src={
                                member.profileImage?.docName
                                  ? `${IMAGE_BASE_URL}/${member.profileImage.docPath}/${member.profileImage.docName}`
                                  : "/assets/images/users/avatar-placeholder.png" // Fallback dummy image
                              }
                              alt={member.name}
                              className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                              onError={(e) => {
                                e.target.src = "/assets/images/users/avatar-placeholder.png";
                              }}
                            />
                            <div className="flex-grow-1">
                              <h6 className="text-md mb-0">{member.name}</h6>
                              <span className="text-sm text-secondary-light fw-medium">
                                {member.companyName || member.category}
                              </span>
                            </div>
                          </div>
